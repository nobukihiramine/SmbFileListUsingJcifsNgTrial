		...
		public void handleMessage( Message message )
		{
			...
			switch( message.what )
			{
				...
				case FileEnumerator.RESULT_FAILED_NOT_A_DIRECTORY:
					...
					finish();
					return;
				case FileEnumerator.RESULT_FAILED_ACCESS_DENIED:
					Toast.makeText( FileListActivity.this, "Access denied. : " + m_strTargetPath, Toast.LENGTH_LONG ).show();
					finish();
					return;
				case FileEnumerator.RESULT_FAILED_FUNCTION_EXISTS:
					Toast.makeText( FileListActivity.this, "Function exists() failed. : " + m_strTargetPath, Toast.LENGTH_LONG ).show();
					finish();
					return;
				case FileEnumerator.RESULT_FAILED_FUNCTION_LISTFILES:
					Toast.makeText( FileListActivity.this, "Function list() failed. : " + m_strTargetPath, Toast.LENGTH_LONG ).show();
					finish();
					return;
				default:
